                  ...
                  <AnimatePresence mode="popLayout">
                    {card && (
                      <motion.div key={card.id}
                        ...
                        animate={{
                          opacity: 1, scale: 1,
                          // attack      → 180° (oponente de cabeça pra baixo na visão do jogador)
                          // defense-open → 0°  (oponente em defesa = de cabeça pra baixo p/ ele = normal p/ jogador)
                          // defense-closed → 0°
                    ...
                    <AnimatePresence mode="popLayout">
                      {card && (
                        <motion.div key={card.id}
                          ...
                          animate={{
                            opacity: 1, scale: 1,
                            // defense-open → 180° (de cabeça pra baixo no campo do jogador)
